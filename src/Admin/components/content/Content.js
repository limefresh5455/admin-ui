            ...
            <div className="dash-content flex-grow-1">
                   <div className="row">
                       <div className="col-md-8 col-7">
                           <h2 className="cus-heading mb-3">All Contents</h2>
                       </div>
                       <div className="col-md-4 col-5 filtrcol">
                           <Link to="add-content"><button className="btn btn-theme-light btn-rounded filters"><i className="fa fa-plus"></i> Add Content</button></Link>
                       </div>
                   </div>
                ...
                <div className="cus-table table-responsive">
                  <table className="table">
                     <thead>
                      ...
                      <th>
                        <div className="form-group">
                          <label for="exampleFormControlInput1">Content Header</label>
                      ...
                      <th>
                        <div className="form-group">
                          <label for="exampleFormControlInput1">Zone</label>
                          <input type="text" className="form-control"/>
                        </div>
                      </th>
                     ...
                     <tbody>
                      ...
                      <tr>
                       <td>
                         <Link to="content-detail" className="clrbt">
